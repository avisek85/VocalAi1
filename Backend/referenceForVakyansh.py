...
device='cpu'
text_to_mel = TextToMel(glow_model_dir='C:\\Users\\DELL\\Downloads\\glow\\glow_ckp', device=device)
mel_to_wav = MelToWav(hifi_model_dir='C:\\Users\\DELL\\Downloads\\hifi\\hifi_ckp', device=device)
